          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Aryan Jha 👋`} <br /><span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Flutter Developer", "iOS Developer", "Backend Developer" ]'><span className="wrap">{text}</span></span></h1>
...
💡 What I Do
<br />
🔹 Mobile & Web App Development – Flutter, FlutterFlow
<br />
🔹 Backend Development – Node.js, Express.js, REST APIs
<br />
🔹 Database Management – SQL, Firebase
<br />
🔹 Open Source & Hackathons – Passionate about innovation</p>
